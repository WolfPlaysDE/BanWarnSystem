...
public class RegisterManager<P extends Plugin> {
  ...
  /**
   * Register events like: RegisterManager<Main> register = new RegisterManager<Main>(this);
  ...
  /**
   * Register a new Command like: RegisterManager<Main> register = new RegisterManager<Main>(this);
   ...
   * @param aliases
   */
  public void registerCommand(String name, String description, CommandExecutor commandClass,
      String... aliases) {
    try {
